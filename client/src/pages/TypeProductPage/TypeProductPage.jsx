...
const TypeProductPage = () => {
  ...
  const filteredProducts = products?.filter((pro) => {
    ...
    const matchesPrice = pro.price >= range[0] && pro.price <= range[1];
  ...
  return (
    <Loading isLoading={loading}>
      ...
      <div style={{ width: "100%", background: "#efefef", height: "100vh" }}>
        <div style={{ width: "1570px", margin: "0 auto", height: "100%" }}>
          <Row
            style={{ flexWrap: "nowrap", paddingTop: "10px", height: "90%" }}
          >
            <WrapperNavbar span={5}>
              <div>
                ...
                <br></br>
                <WrapperContent1>Giá tiền</WrapperContent1>
                <div>
                  <Slider
                    min={10000}
                    max={20000000}
                  ...
                  />
                  <WrapperContent1>
                    Gia tiền từ: {convertPrice(range[0])} -{" "}
                    {convertPrice(range[1])}
                  </WrapperContent1>
                  <div style={{ paddingTop: "20px" }}>
                    <Button type="primary">Áp dụng lọc giá</Button>
                  </div>
                </div>
              </div>
            </WrapperNavbar>
