    ...
    return(
        <div style={{display:'flex', alignItems:'center',justifyContent:'center',background:'#efefef', height:"100vh"}}>
            ...
            <WrapperContainerLeft>
                ...
                <div style={{position:'relative'}}>
                    <span onClick={()=>setIsShowPConfirmPassWord(!isShowConfirmPassWord)} 
                        style={{
                        zIndex:10,
                        position:'absolute',
                        top:'11px',
                ...
                <ButtonComponent
                    ...
                    {/* </Loading> */}
                    <p style={{margin:'0px'}}>Bạn đã có tài khoản? <WrapperTextLight onClick={handleNavigateSignIn}>Đăng nhập</WrapperTextLight></p>
            </WrapperContainerLeft>
